...
The Haskell [Stack](https://docs.haskellstack.org/en/stable/README/) tool was utilized for development.

The program consists of three main folders:
...
## Installing Stack
Stack can be installed on most Unix-like (Unix) operating systems, including macOS, and on Windows.
For Unix OS, run:
```
...
executable, that is the **main** method from [Main.hs](https://github.com/ArastunM/Exec-Machine/blob/main/app/Main.hs).
...
## Testing
Testing of the program has been automated using the Stack tool.
